  ...
  const onSubmit = () => {
    if (name && email && mobile && message) {
      ...
      emailjs.send(serviceId, templateId, templateParams, userId)
        .then(response => {
          setMsg('Мы скоро свяжемся с Вами!')
          setTimeout(() => {
            setMsg("")
            setEmail("")
            setMessage("")
      ...
      setError('Пожалуйста укажите детали')
      setTimeout(() => {
        setError("")
      }, 2000);
    }
          ...
          <div class="row g-0 mx-lg-0">
            ...
            >
              ...
              >
                ...
                Оставьте сообщение и мы Вам поможем
                </p>
              </div>
            </div>
            <div
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                      <div class="form-floating">
                        ...
                        />
                        <label for="gmail">Ваша электронная почта</label>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-floating">
                        ...
                        />
                        <label for="cname">Ваш мобильный номер</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-floating">
